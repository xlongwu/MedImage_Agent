...
3. ✅ docs/项目概览/项目目标.md（项目长期目标）
4. ✅ docs/ARCHITECTURE.md（完整架构文档）
5. ✅ docs/项目概览/路线图.md（本文档）
6. ✅ docs/项目概览/任务清单.md（可执行任务池）
7. ✅ docs/安全与审批/安全边界.md（安全边界文档）
8. ✅ docs/开发与测试/开发工作流.md（开发工作流文档）
9. ✅ docs/架构与决策/决策记录/0001_智能体运行时边界.md（ADR-001）
10. ✅ docs/架构与决策/决策记录/0002_原始数据只读.md（ADR-002）
