...
|----------|------|
| `docs/桌面与前端/界面手工智能体威胁模型.md` (T001) | Gap #7: "Bypass of Reviewed Execution Pipeline" |
| `docs/桌面与前端/界面人工审批设计.md` (T002) | Integration strategy: Option B Phase 1 recommended |
| `tests/unit/test_gui_reviewed_execution_blocklist.py` (T004) | `test_gui_bypass_gap_still_exists` |
| `docs/桌面与前端/界面手工冒烟指南.md` (T006) | Section 4.7: Bypass Awareness Check |
| `docs/阶段完成记录/M9_界面手工阶段收尾.md` (CLOSEOUT) | Section 12: Known Safety Gap |
...
| Document | Content |
|----------|---------|
| `docs/安全与审批/安全审阅执行设计.md` | 14-condition preflight gate design |
| `docs/架构与决策/执行集成设计.md` | M5 execution integration design |
| `docs/桌面与前端/界面手工智能体威胁模型.md` | M9 T001 — threat model and inventory |
| `docs/桌面与前端/界面人工审批设计.md` | M9 T002 — approval and HITL design |
| `docs/桌面与前端/界面动作分类与沙箱契约.md` | M9 T003 — action taxonomy and contracts |
| `docs/桌面与前端/界面只读观察契约.md` | M9 T005 — observation contract |
| `docs/桌面与前端/界面手工冒烟指南.md` | M9 T006 — manual smoke guide |
| `docs/阶段完成记录/M9_界面手工阶段收尾.md` | M9 CLOSEOUT — phase closeout |
| `docs/阶段完成记录/M6至M9_安全架构审查.md` | This document |
