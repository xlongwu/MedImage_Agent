...
| Document | Content |
|----------|------|
| `docs/项目概览/当前状态兼容说明.md` | Phase completion status |
| `docs/阶段完成记录/M11_仅夹具界面模型发布检查点.md` | Release checkpoint |
| `docs/阶段完成记录/M11_契约测试基线锁定.md` | Contract test baseline |
| `docs/阶段完成记录/M10_完整测试基线锁定.md` | Previous baseline |
| `docs/阶段完成记录/M6至M9_安全架构审查.md` | Safety architecture |
