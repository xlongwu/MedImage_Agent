...
|----------|------|
| `docs/规划与运行时/真实模型集成威胁模型.md` | 15 threat surfaces, 17 non-negotiable invariants |
| `docs/规划与运行时/模型运行时隔离设计.md` | 7-layer isolation, resource budgets, scoped filesystem |
| `docs/规划与运行时/模型提供方策略门设计.md` | 8 provider types, 20-step gate, 15 error codes |
| `docs/规划与运行时/模型推理输入脱敏设计.md` | 5 allowed classes, 20 blocked, 13 redaction patterns |
| `docs/规划与运行时/模型输出审计元数据持久化设计.md` | 15 events, unified 6-section schema, 19 forbidden fields |
| `docs/规划与运行时/模拟与真实边界测试设计.md` | ~120 tests, 10 categories, acceptance gate |
| `docs/阶段完成记录/M11_真实模型集成设计收尾.md` | This document |
...
| Document | Phase |
|----------|:---:|
| `docs/规划与运行时/真实模型集成威胁模型.md` | T001 |
| `docs/规划与运行时/模型运行时隔离设计.md` | T002 |
| `docs/规划与运行时/模型提供方策略门设计.md` | T003 |
| `docs/规划与运行时/模型推理输入脱敏设计.md` | T004 |
| `docs/规划与运行时/模型输出审计元数据持久化设计.md` | T005 |
| `docs/规划与运行时/模拟与真实边界测试设计.md` | T006 |
| `docs/阶段完成记录/M10_完整测试基线锁定.md` | Baseline |
| `docs/阶段完成记录/M10_界面智能体模拟集成收尾.md` | Previous closeout |
