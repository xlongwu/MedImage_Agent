...
|------|:---:|------|:---:|:---:|
| **M9-GUI-T001** | ✅ | `docs/桌面与前端/界面手工智能体威胁模型.md` | No | No |
| **M9-GUI-T002** | ✅ | `docs/桌面与前端/界面人工审批设计.md` | No | No |
| **M9-GUI-T003** | ✅ | `docs/桌面与前端/界面动作分类与沙箱契约.md` | No | No |
| **M9-GUI-T004** | ✅ | `tests/unit/test_gui_reviewed_execution_blocklist.py` (38 tests) | Test only | No |
| **M9-GUI-T005** | ✅ | `docs/桌面与前端/界面只读观察契约.md` | No | No |
| **M9-GUI-T006** | ✅ | `docs/桌面与前端/界面手工冒烟指南.md` | No | No |
| **M9-GUI-CLOSEOUT** | ✅ | `docs/阶段完成记录/M9_界面手工阶段收尾.md` | No | No |
...
|----------|:---:|------|
| `docs/桌面与前端/界面手工智能体威胁模型.md` | T001 | Threat model, node inventory, 7 attack surfaces, 5 safety gaps |
| `docs/桌面与前端/界面人工审批设计.md` | T002 | Three-layer approval model, provider policy, HITL requirements, integration strategy |
| `docs/桌面与前端/界面动作分类与沙箱契约.md` | T003 | 29-action taxonomy, sandbox declaration schema (23 fields), 5 policy contracts, classification rules |
| `docs/桌面与前端/界面只读观察契约.md` | T005 | Tier 0 observation contract, screenshot policy, sensitive data policy, audit requirements |
| `docs/桌面与前端/界面手工冒烟指南.md` | T006 | 36-item manual smoke checklist, failure diagnostics, cleanup guide |
| `docs/阶段完成记录/M9_界面手工阶段收尾.md` | CLOSEOUT | This document — phase summary |
...
| Document | Content |
|----------|---------|
| `docs/桌面与前端/界面手工智能体威胁模型.md` | Threat model, inventory, 7 attack surfaces, 5 safety gaps |
| `docs/桌面与前端/界面人工审批设计.md` | Three-layer approval model, provider policy, integration strategy |
| `docs/桌面与前端/界面动作分类与沙箱契约.md` | 29-action taxonomy, sandbox declaration schema, 5 policy contracts, classification rules |
| `docs/桌面与前端/界面只读观察契约.md` | Tier 0 observation contract, screenshot/clipboard/audit policies |
| `docs/桌面与前端/界面手工冒烟指南.md` | 36-item manual smoke checklist, failure diagnostics |
| `docs/阶段完成记录/M9_界面手工阶段收尾.md` | This document |
