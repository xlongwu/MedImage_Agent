...
| Document | Content |
|----------|---------|
| `docs/桌面与前端/界面智能体接口防护设计.md` | 14-layer guard pipeline design |
| `docs/桌面与前端/界面动作分类与沙箱契约.md` | 29-action taxonomy, 5 policy contracts |
| `docs/桌面与前端/界面只读观察契约.md` | Tier 0 observation contract |
| `docs/桌面与前端/界面手工智能体威胁模型.md` | Original threat model and bypass analysis |
| `docs/桌面与前端/界面人工审批设计.md` | Three-layer approval model |
| `docs/阶段完成记录/M6至M9_安全架构审查.md` | Cross-phase safety architecture |
| `docs/阶段完成记录/M9_界面手工阶段收尾.md` | M9 design phase closeout |
| `docs/阶段完成记录/M9_界面智能体接口防护收尾.md` | This document |
