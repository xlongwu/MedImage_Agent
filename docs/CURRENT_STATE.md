...
### Summary: 35 reviewed execution nodes (7 SPM + 20 DPABI + 8 GPU)
...
| Subject-level ReHo | 1 |
| Subject-level Temporal Filtering | 1 |
| Subject-level Functional Connectivity | 1 |

### Still Blocked

| Category | Count |
|----------|:---:|
| GPU subject execution (nuisance) | 1 |
| GUI/manual | TBD |
