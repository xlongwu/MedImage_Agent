...
> Historical design: this public external-converter UI proposal is retained for
> audit only. Current source UI and deferred visible-Electron validation are
> tracked in `PROJECT_STATE.md` and the Phase 10 record.
