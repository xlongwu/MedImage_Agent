...
**Version:** v1.0-draft
**Date:** 2026-06-08
**Parent:** `docs/预处理与科学计算/DICOM转换/DICOM到NIfTI执行包装契约.md`

> Historical design baseline: the gate model below predates the in-project
> Python converter and sole reviewed Execution Gateway. Current approval,
> readiness, audit, and ticket behavior is documented in `PROJECT_STATE.md`,
> the safety boundary, and the run lifecycle.
...
Following the pattern in `docs/预处理与科学计算/SPM/安全允许列表策略.md`:
