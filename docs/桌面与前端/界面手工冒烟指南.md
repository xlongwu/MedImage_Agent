...
| Document | Purpose |
|----------|---------|
| `docs/桌面与前端/界面手工智能体威胁模型.md` | Threat model and inventory |
| `docs/桌面与前端/界面人工审批设计.md` | Approval + HITL design |
| `docs/桌面与前端/界面动作分类与沙箱契约.md` | Action taxonomy + sandbox contract |
| `docs/桌面与前端/界面只读观察契约.md` | Read-only observation contract |
| `docs/桌面与前端/界面手工冒烟指南.md` | This guide |
...
**Document:** `docs/桌面与前端/界面只读观察契约.md`
...
| Document | Content |
|----------|---------|
| `docs/桌面与前端/界面手工智能体威胁模型.md` | Threat model, inventory, taxonomy |
| `docs/桌面与前端/界面人工审批设计.md` | Three-layer approval model, provider policy |
| `docs/桌面与前端/界面动作分类与沙箱契约.md` | 29-action taxonomy, sandbox declaration schema |
