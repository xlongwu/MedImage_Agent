...
|---|---|
| `docs/桌面与前端/界面手工智能体威胁模型.md` | M9-GUI-T001 — threat model and inventory |
| `docs/项目概览/当前状态兼容说明.md` | Current milestone status |
| `docs/项目概览/后续工作.md` | Next actions pointer |
| `docs/安全与审批/安全审阅执行设计.md` | 14-condition preflight gate (model for GUI gates) |
| `docs/架构与决策/执行集成设计.md` | M5 execution integration |
