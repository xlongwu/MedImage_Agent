...
| AD-6 | 状态文档更新但不修改历史 release notes | `PROJECT_STATE.md` 反映当前状态；`docs/发布记录/v0.5.0-rc1.md` 保持不变 |
...
**Description**: 更新 `PROJECT_STATE.md` 和新建 `docs/项目概览/能力矩阵.md`，明确每个预处理阶段的真实能力等级。
...
- [ ] 新建 `docs/项目概览/能力矩阵.md`，按阶段列出能力等级：
...
- [ ] `docs/项目概览/能力矩阵.md` 中每个阶段都可追溯到对应服务代码

**Files likely touched:**
- `PROJECT_STATE.md`
- `docs/项目概览/能力矩阵.md` (new)
...
- [ ] 验收结果记录到 `docs/桌面与前端/桌面冒烟报告_v0.5.0.md`

**Files likely touched:**
- `docs/桌面与前端/桌面冒烟报告_v0.5.0.md` (new)
- `PROJECT_STATE.md` (更新)
