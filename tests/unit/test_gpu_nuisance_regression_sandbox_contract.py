...
def test_gpu_fc_allowed():
    ...
    plan = {
        ...
        "nodes": [
            {
                "id": "gpu_functional_connectivity_subject",
                "depends_on": [],
                "params": {
                    "sandbox_mode": True,
                    "subject_level": True,
    ...
    assert (
        ...
        in policy["allowed_gpu_functional_connectivity_sandbox_nodes"]
    )
...
def test_nuisance_sandbox_allowed():
    ...
    plan = {
        ...
        "nodes": [
            {
                "id": "gpu_nuisance_regression_subject",
                "depends_on": [],
                "params": {
                    "sandbox_mode": True,
                    "subject_level": True,
    ...
    policy = classify_plan_nodes(plan)
    assert (
        "gpu_nuisance_regression_subject" in policy["allowed_gpu_nuisance_regression_sandbox_nodes"]
    )
...
def test_nuisance_no_sandbox_blocked():
    ...
    assert (
        ...
        not in policy["allowed_gpu_nuisance_regression_sandbox_nodes"]
    )
