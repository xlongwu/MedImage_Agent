"""Sandbox contract tests for gpu_reho_subject (M8-GPU-T008c)."""
...
def test_gpu_alff_allowed():
    from src.backend.app.planner.plan_adapter import classify_plan_nodes
    plan = {"pipeline_id": "t", "nodes": [
        {"id": "gpu_alff_subject", "depends_on": [], "params": {"sandbox_mode": True, "subject_level": True,
