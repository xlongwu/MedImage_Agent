...
def test_other_modules_still_present_with_nifti_cache_hit(tmp_path, monkeypatch):
    ...
    expected = {"data_readiness", "bids_validation", "conversion_dry_run",
                "nifti_qc_snapshot", "bold_reference_readiness",
                "motion_qc_readiness", "motion_metrics_draft", "rsfmri_qc_planning"}
