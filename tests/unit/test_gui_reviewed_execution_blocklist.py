...
def test_gui_prefixed_node_blocked_unknown():
    plan = {
        "pipeline_id": "test",
        "nodes": [
            {"id": "gui_batch_editor", "depends_on": [], "params": {"target_app": "MATLAB"}},
        ],
    }
...
def test_gui_node_not_allowed_python():
    plan = {
        "pipeline_id": "test",
        "nodes": [
            {"id": "gui_spm_assist", "backend": "python", "depends_on": [], "params": {}},
        ],
    }
    policy = classify_plan_nodes(plan)
...
def test_backend_gui_agent_blocked():
    plan = {
        "pipeline_id": "test",
        "nodes": [
            {"id": "my_gui_action", "backend": "gui-agent", "depends_on": [], "params": {}},
        ],
    }
    policy = classify_plan_nodes(plan)
...
def test_backend_manual_blocked():
    plan = {
        "pipeline_id": "test",
        "nodes": [
            {"id": "manual_review_step", "backend": "manual", "depends_on": [], "params": {}},
        ],
    }
    policy = classify_plan_nodes(plan)
...
def test_backend_desktop_blocked():
    plan = {
        "pipeline_id": "test",
        "nodes": [
            {"id": "desktop_action", "backend": "desktop", "depends_on": [], "params": {}},
        ],
    }
    policy = classify_plan_nodes(plan)
...
def test_backend_browser_blocked():
    plan = {
        "pipeline_id": "test",
        "nodes": [
            {"id": "browser_action", "backend": "browser", "depends_on": [], "params": {}},
        ],
    }
    policy = classify_plan_nodes(plan)
...
def _hr_plan_for_gui():
    ...
    return {
        ...
        "nodes": [
            ...
            {"id": "gui_acpc_manual", "backend": "gui-agent", "depends_on": [], "params": {}},
        ],
    }
...
def _gui_preflight_body(monkeypatch, tmp_path, **overrides):
    ...
    body = {
        "plan": {
            "pipeline_id": "test",
            "nodes": [
                {"id": "gui_batch_editor", "backend": "gui-agent", "depends_on": [], "params": {}},
            ],
        },
        "approval": {
            "approved": True,
...
def test_gui_agent_backend_no_execution(monkeypatch, tmp_path):
    body = _gui_preflight_body(
        ...
        plan={
            "pipeline_id": "test",
            "nodes": [
                {"id": "my_gui_node", "backend": "gui-agent", "depends_on": [], "params": {}},
            ],
        },
    )
    resp = client.post("/api/plans/execute-reviewed", json=body)
...
def test_gui_manual_backend_no_execution(monkeypatch, tmp_path):
    body = _gui_preflight_body(
        ...
        plan={
            "pipeline_id": "test",
            "nodes": [
                {"id": "manual_step", "backend": "manual", "depends_on": [], "params": {}},
            ],
        },
    )
    resp = client.post("/api/plans/execute-reviewed", json=body)
...
def test_gui_desktop_backend_no_execution(monkeypatch, tmp_path):
    body = _gui_preflight_body(
        ...
        plan={
            "pipeline_id": "test",
            "nodes": [
                {"id": "desktop_step", "backend": "desktop", "depends_on": [], "params": {}},
            ],
        },
    )
    resp = client.post("/api/plans/execute-reviewed", json=body)
...
def test_gui_browser_backend_no_execution(monkeypatch, tmp_path):
    body = _gui_preflight_body(
        ...
        plan={
            "pipeline_id": "test",
            "nodes": [
                {"id": "browser_step", "backend": "browser", "depends_on": [], "params": {}},
            ],
        },
    )
    resp = client.post("/api/plans/execute-reviewed", json=body)
