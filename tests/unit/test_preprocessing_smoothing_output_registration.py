...
from src.backend.app.services.preprocessing_stage_outputs import (  # noqa: E402
    register_smoothing_outputs,  # noqa: E402
)
...
def test_blocks_zero_outputs(tmp_path):
    ...
    result = register_smoothing_outputs(
        "brain-tumor-study",
        "pp-test",
        StageOutputRegistrationRequest(execution_id="s-ex-abc"),
...
def test_endpoint_200(tmp_path):
    ...
    resp = client.post(
        "/api/projects/brain-tumor-study/preprocessing/runs/pp-test/stage-outputs/register-smoothing",
