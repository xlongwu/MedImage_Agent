  ...
  return (
    <Sec>
      ...
      <div style={{ padding: 8, border: "1px solid rgba(242, 153, 74, 0.28)", borderRadius: 6, background: "rgba(255, 251, 242, 0.94)", fontSize: 11, color: "#9a5a15", marginBottom: 12 }}>
        Dry-run only. MATLAB/SPM is not executed. No files or directories are created. Predicted output paths are previews, not real outputs. Research-use only. Not for clinical diagnosis.
      </div>
