    ...
    <div>
      <div className="row">
        <button className="dangerButton" onClick={handleRun}>
          Approve and Run Segmentation + Tissue QC
        </button>
        <button onClick={handleLoad}>Load Tissue QC Results</button>
      ...
      <JsonBlock value={loaded?.tissue_qc_summary} emptyText="No tissue QC summary available" />

      <h3>Subject Tissue QC</h3>
      <JsonBlock value={loaded?.subject_tissue_qc} emptyText="No subject tissue QC available" />
