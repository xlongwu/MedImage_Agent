    ...
    >
      <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
        ...
        <span
          style={{
            ...pill,
            background: candidate.has_sidecar ? "#e8f5e9" : "#fff7ed",
            color: candidate.has_sidecar ? "#176b3b" : "#9a5a15",
        ...
        <span
          style={{
            ...pill,
            background: candidate.has_motion_params ? "#e8f5e9" : "#ffebee",
            color: candidate.has_motion_params ? "#176b3b" : "#b53b3b",
            borderColor: candidate.has_motion_params
              ? "rgba(33, 150, 83, 0.24)"
              : "rgba(235, 87, 87, 0.26)",
          }}
        >
          motion: {String(candidate.has_motion_params)}
        </span>
        <span
          style={{
            ...pill,
            background: candidate.has_fd_column ? "#e8f5e9" : "#fff7ed",
            color: candidate.has_fd_column ? "#176b3b" : "#9a5a15",
            borderColor: candidate.has_fd_column
              ? "rgba(33, 150, 83, 0.24)"
              : "rgba(242, 153, 74, 0.28)",
          }}
        >
          FD: {String(candidate.has_fd_column)}
        </span>
      </div>
