                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...pill,
                          background: s.has_fd ? "#e8f5e9" : "#fff7ed",
                          color: s.has_fd ? "#176b3b" : "#9a5a15",
                          borderColor: s.has_fd
                            ? "rgba(33, 150, 83, 0.24)"
                      ...
                      {s.max_abs_translation_mm != null && (
                        <span>max trans: {s.max_abs_translation_mm.toFixed(2)}mm</span>
                      )}
                    </div>
                    {s.qc_flags.length > 0 && (
                      <div style={{ color: "#b53b3b", fontSize: 11 }}>{s.qc_flags.join("; ")}</div>
                    )}
                  </div>
                ))}
              </div>
