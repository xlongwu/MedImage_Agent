...
export function IntroCard({ onStart }: { onStart: () => void }) {
  return (
    <div style={{ textAlign: "center", padding: "40px 20px" }}>
      ...
      >
        A visual, reproducible preprocessing platform for rs-fMRI data. Supports SPM, DPABI, and
        Python-based pipelines with automatic QC, dataset evaluation, and report generation.
      </p>
      ...
      <div style={{ marginTop: 24, fontSize: 12, color: "#999" }}>
        Backend:{" "}
        <a href={`${DEFAULT_API_BASE}/api/health`} target="_blank" style={{ color: "#1976d2" }}>
          {DEFAULT_API_BASE}
        </a>
      </div>
    </div>
