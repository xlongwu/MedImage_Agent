      ...
      <div style={{ flex: 1, padding: 16, overflow: "auto", maxHeight: "calc(100vh - 60px)" }}>
        {tab === "system" && (
          <>
            ...
            <Section title="Import Diagnostics">
              <ImportDiagnosticsPanel baseUrl={baseUrl} />
            </Section>
            <Section title="External SPM / DPABI Smoke">
              <ExternalSmokePanel baseUrl={baseUrl} />
            </Section>
            <Section title="Pipeline Explorer">
              <PipelineExplorer
                baseUrl={baseUrl}
        ...
        {tab === "pipeline" && (
          <>
            ...
            <Section title="rs-fMRI Preprocessing Plan">
              <RsfmriPreprocessingPlanPanel baseUrl={baseUrl} />
            </Section>
            <Section title="Error Diagnosis">
        ...
        {tab === "preproc" && (
          <>
            <Section title="SPM Slice Timing + Motion QC">
              <RsfmriSliceTimingPanel baseUrl={baseUrl} />
            </Section>
            <Section title="SPM Realign + Motion Chain">
              <RsfmriStRealignMotionChainPanel baseUrl={baseUrl} />
            </Section>
            <Section title="SPM Coregistration QC">
              <RsfmriCoregistrationQcPanel baseUrl={baseUrl} />
            </Section>
            <Section title="SPM Segmentation Tissue QC">
              <RsfmriSegmentationTissueQcPanel baseUrl={baseUrl} />
            </Section>
            <Section title="SPM Normalization QC">
              <RsfmriNormalizationQcPanel baseUrl={baseUrl} />
            </Section>
            <Section title="SPM Smoothing QC">
        ...
        {tab === "reports" && (
          <>
            ...
            <Section title="Report Validator">
        ...
        {tab === "insights" && (
          <>
            <Section title="Insights Dashboard">
              <InsightsDashboardPanel baseUrl={baseUrl} />
            </Section>
            <Section title="Session Memory">
              <SessionMemoryBrowserPanel baseUrl={baseUrl} />
            </Section>
            <Section title="Advisor Center">
              <AdvisorCenterPanel baseUrl={baseUrl} />
            </Section>
          </>
        )}
        {tab === "release" && (
