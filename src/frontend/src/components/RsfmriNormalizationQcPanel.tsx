...
import { getRsfmriNormalizationQc, runRsfmriNormalizationQc } from "../lib/api/rsfmri";
...
export function RsfmriNormalizationQcPanel({ baseUrl }: Props) {
  const { t } = useI18n();
  const operation = t("technical.normalization.operation");
  const name = t("technical.normalization.name");
  ...
  return (
    <div>
      ...
      <div className="metricGrid">
        ...
        <div className="metricCard">
          <span>{t("technical.normalization.metric")}</span>
          <strong>
