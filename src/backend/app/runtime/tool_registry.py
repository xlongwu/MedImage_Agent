...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    "pipeline.plan": ToolSpec(
        ...
        parallel_safe=True,
        allowed_read_paths=["examples/", "specs/", "outputs/work/"],
        allowed_write_paths=["outputs/work/agent_runs/"],
    ),
    "pipeline.execute": ToolSpec(
        ...
        parallel_safe=False,
        allowed_read_paths=["examples/", "outputs/work/", "matlab/", "third_party/"],
        allowed_write_paths=["outputs/work/", "outputs/logs/", "outputs/reports/", "outputs/derivatives/"],
    ),
}
