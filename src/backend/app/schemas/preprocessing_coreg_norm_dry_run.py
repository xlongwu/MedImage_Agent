...
class CoregNormDryRunRequest(BaseModel):
    ...
    coreg_target: str = "mean_functional"; normalization_voxel_size: str = "[3,3,3]"
    write_normalized_functional: bool = True; write_normalized_t1w: bool = True
...
class CoregNormDryRunResponse(BaseModel):
    ...
    functional_input_count: int = 0; t1w_count: int = 0
    mean_functional_count: int = 0; motion_parameter_count: int = 0
...
def coreg_norm_safety_flags() -> dict[str, bool]:
    return {"dry_run_only": True, "no_matlab_executed": True, "no_spm_executed": True,
            ...
            "converted_input_not_modified": True, "sandbox_outputs_not_modified": True,
            "no_external_tools_executed": True, "no_full_preprocessing": True,
