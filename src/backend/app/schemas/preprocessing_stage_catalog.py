...
PREPROCESSING_STAGE_CATALOG: tuple[PreprocessingStageSpec, ...] = (
    ...
    PreprocessingStageSpec(
        ...
        supported_backends=["spm12"],
        default_backend="spm12",
        requires_external_tool=True,
        requires_approval=True,
        requires_env_flags=SPM_STAGE_ENV_FLAGS,
        can_run_in_ci=False,
        scientific_status="scaffolded",
        validation_status="external_env_gated",
        initial_status="blocked",
        description="SPM/MATLAB stage; disabled until external-tool gates are explicitly met.",
    ),
    PreprocessingStageSpec(
        ...
        validation_status="external_env_gated",
        initial_status="blocked",
        description="SPM realignment remains external, approval-gated, and disabled by default.",
    ),
    PreprocessingStageSpec(
        ...
        requires_external_tool=True,
        requires_approval=True,
        requires_env_flags=SPM_COREG_NORM_ENV_FLAGS,
        can_run_in_ci=False,
        scientific_status="scaffolded",
        validation_status="external_env_gated",
        initial_status="blocked",
        prerequisite_notes=["Requires a mean functional reference and a T1w anatomical input."],
        description="Optional SPM spatial stage; not required for native-space FC.",
    ),
    PreprocessingStageSpec(
        ...
        description="Optional SPM stage for tissue masks and normalization prerequisites.",
    ),
    PreprocessingStageSpec(
        ...
        description="Optional SPM normalization; required only for MNI-atlas workflows.",
    ),
    PreprocessingStageSpec(
        ...
        requires_external_tool=True,
        requires_approval=True,
        requires_env_flags=SPM_SMOOTHING_ENV_FLAGS,
        can_run_in_ci=False,
        scientific_status="scaffolded",
        validation_status="external_env_gated",
        initial_status="blocked",
        ...
        description="Optional SPM smoothing; FC input choice remains configuration-dependent.",
    ),
    PreprocessingStageSpec(
    ...
    PreprocessingStageSpec(
        ...
        output_artifact_types=["roi_timeseries", "fc_matrix", "fisher_z_matrix", "stage_manifest", "qc_json"],
