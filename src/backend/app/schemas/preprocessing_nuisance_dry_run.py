"""Nuisance Regression Dry-Run Schema — Phase 5J."""
from __future__ import annotations
from pydantic import BaseModel, Field


class NuisanceDryRunRequest(BaseModel):
    registered_stage_output_id: str = ""; functional_input_dir: str = ""
    include_motion_24: bool = True; include_wm_csf: bool = False
    include_global_signal: bool = False; include_linear_trend: bool = True
...
class NuisanceDryRunResponse(BaseModel):
    ...
    functional_input_count: int = 0; motion_parameter_count: int = 0
    regressor_design_paths: list[str] = Field(default_factory=list)
