...
class SmoothingSandboxExecutionRequest(BaseModel):
    ...
    confirm_no_converted_input_modification: bool = False; confirm_previous_stage_readonly: bool = False
    confirm_smoothing_only: bool = False; confirm_no_full_preprocessing: bool = False
...
def smoothing_safety_flags() -> dict[str, bool]:
    return {"sandbox_execution_only": True, "rawdata_not_modified": True,
            "converted_input_not_modified": True, "previous_stage_outputs_not_modified": True,
            "no_full_preprocessing": True, "no_dpabi": True, "no_shell_execution": True,
            "argv_list_only": True, "smoothing_only": True,
