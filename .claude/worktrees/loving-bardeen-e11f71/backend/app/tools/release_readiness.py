...
def build_release_readiness():
    ...
    chk("report_package", "exports dir exists", Path("exports/rsfmri_report_package").is_dir())
    chk("release_artifacts", "reports dir exists", Path("reports").is_dir())
    ...
    out = Path("reports/release_readiness"); out.mkdir(parents=True, exist_ok=True)
