...
def write_dpabi_temporal_filtering_contract(work_dir: str = "./work") -> dict[str, Any]:
    ...
    payload = {
        ...
        "planned_inputs": ["derivatives/rsfmri_preproc/{subject_id}/func/resid_swr*.nii", "derivatives/rsfmri_qc/{subject_id}/slice_timing_qc.json"],
        "planned_outputs": ["derivatives/rsfmri_preproc/{subject_id}/func/dpabi_filtered_resid_swr*.nii", "logs/{subject_id}_dpabi_temporal_filtering.log"],
