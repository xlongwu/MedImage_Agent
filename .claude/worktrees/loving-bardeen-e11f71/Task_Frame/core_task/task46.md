...
def write_functional_connectivity_gpu_candidate_contract(
    ...
    payload = {
        ...
        "planned_outputs": [
            "derivatives/rsfmri_fc/{subject_id}/gpu_correlation_matrix.tsv",
            "derivatives/rsfmri_fc/{subject_id}/gpu_seed_correlation_map.nii"
        ],
...
def write_dpabi_functional_connectivity_contract(
    ...
    payload = {
        ...
        "planned_outputs": [
            "derivatives/rsfmri_fc/{subject_id}/dpabi_correlation_matrix.tsv",
            "logs/{subject_id}_dpabi_functional_connectivity.log"
        ],
        "parameters": {
...
def main() -> int:
    ...
    if approved:
        pipeline = _make_approved_pipeline_copy(
            source=pipeline,
            target=Path("work/rsfmri/approved_pipeline_functional_connectivity.yaml"),
        )
