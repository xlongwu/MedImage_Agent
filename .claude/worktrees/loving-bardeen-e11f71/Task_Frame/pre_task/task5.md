...
{
  "ok": true,
  "prepared_path": "work/spm_inputs/sub-001/sub-001_task-rest_bold.nii",
  "errors": []
}
...
返回结构化 dict：
{
  ...
  "backend": "python",
  "subject_id": "sub-001",
  "outputs": ["derivatives/qc/sub-001/subject_qc.json"],
  "metrics": {
    "shape": [16, 16, 16, 10],
    "mean": 0.01,
    "std": 0.95,
...

{
  ...
  "subjects_failed": 0,
  "node_states": [
    "work/states/run_subject_preprocess_001/create_synthetic_bids.json",
    "work/states/run_subject_preprocess_001/data_inspection.json",
    "work/states/run_subject_preprocess_001/sub-001/spm_smooth_subject.json",
    "work/states/run_subject_preprocess_001/sub-001/subject_qc.json",
