...
def write_alff_falff_gpu_candidate_contract(
    ...
    payload = {
        ...
        "planned_outputs": [
            "derivatives/rsfmri_metrics/{subject_id}/alff_gpu.nii",
            "derivatives/rsfmri_metrics/{subject_id}/falff_gpu.nii"
        ],
        "safety": {
            "gpu_executed": False,
...
def write_dpabi_alff_falff_contract(
    ...
    payload = {
        ...
        "planned_outputs": [
            "derivatives/rsfmri_metrics/{subject_id}/dpabi_alff.nii",
            "derivatives/rsfmri_metrics/{subject_id}/dpabi_falff.nii",
            "logs/{subject_id}_dpabi_alff_falff.log"
        ],
        "parameters": {
            "low_hz": 0.01,
            "high_hz": 0.08,
...
def main() -> int:
    ...
    if approved:
        pipeline = _make_approved_pipeline_copy(
            source=pipeline,
            target=Path("work/rsfmri/approved_pipeline_alff_falff.yaml"),
        )
