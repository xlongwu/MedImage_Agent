...
def get_rsfmri_core_step_registry() -> list[PreprocessingStepSpec]:
    return [
        ...
        PreprocessingStepSpec(
            ...
            inputs=["work/dataset_index/dataset_index.json"],
            outputs=["work/preprocessing/rsfmri/anat_func_pairs.json"],
            parameters={
        ...
        PreprocessingStepSpec(
            ...
            inputs=["func_bold"],
            outputs=["derivatives/rsfmri_preproc/{subject_id}/func/a{run_id}_bold.nii"],
            parameters={
        ...
        PreprocessingStepSpec(
            ...
            outputs=[
                "derivatives/rsfmri_preproc/{subject_id}/func/r{run_id}_bold.nii",
                "derivatives/rsfmri_preproc/{subject_id}/func/rp_{run_id}.txt",
            ],
            parameters={
                "quality": 0.9,
                "separation": 4,
        ...
        PreprocessingStepSpec(
            ...
            outputs=[
                "derivatives/rsfmri_preproc/{subject_id}/anat/coregistered_t1w.nii"
            ],
            parameters={
                "cost_function": "nmi",
            },
        ...
        PreprocessingStepSpec(
            ...
            inputs=["anat_t1w"],
            outputs=[
                "derivatives/rsfmri_preproc/{subject_id}/anat/c1_t1w.nii",
                "derivatives/rsfmri_preproc/{subject_id}/anat/c2_t1w.nii",
                "derivatives/rsfmri_preproc/{subject_id}/anat/c3_t1w.nii",
                "derivatives/rsfmri_preproc/{subject_id}/anat/y_t1w.nii",
            ],
            parameters={
                "spm_tpm": "default",
            },
        ...
        PreprocessingStepSpec(
            ...
            outputs=[
                "derivatives/rsfmri_preproc/{subject_id}/func/w{run_id}_bold.nii"
            ],
            parameters={
                "voxel_size": [3, 3, 3],
        ...
        PreprocessingStepSpec(
            ...
            outputs=[
                "derivatives/rsfmri_preproc/{subject_id}/func/sw{run_id}_bold.nii"
            ],
            parameters={
                "fwhm": [6, 6, 6],
        ...
        PreprocessingStepSpec(
            ...
            outputs=[
                "derivatives/rsfmri_preproc/{subject_id}/func/regressed_{run_id}_bold.nii"
            ],
            parameters={
        ...
        PreprocessingStepSpec(
            ...
            outputs=[
                "derivatives/rsfmri_preproc/{subject_id}/func/filtered_{run_id}_bold.nii"
            ],
            parameters={
                "low_hz": 0.01,
                "high_hz": 0.08,
        ...
        PreprocessingStepSpec(
            ...
            outputs=[
                "reports/rsfmri/{subject_id}_qc_report.md",
                "reports/rsfmri/{subject_id}_qc_summary.json",
            ],
            parameters={
                "fd_threshold": 0.5,
        ...
        PreprocessingStepSpec(
            ...
            inputs=["reports/rsfmri/*_qc_summary.json"],
            outputs=[
                "reports/rsfmri/dataset_qc_summary.json",
                "reports/rsfmri/dataset_qc_report.md",
                "reports/rsfmri/dataset_qc_report.html",
            ],
            parameters={
