...
def _load_error_kb(kb_path: str = "memory/global/ERROR_KB.yaml") -> dict[str, Any]:
    try:
        import yaml
    except ImportError:
...
def classify_error(
    message: str,
    kb_path: str = "memory/global/ERROR_KB.yaml",
) -> dict[str, Any]:
...
def validate_error_kb(kb_path: str = "memory/global/ERROR_KB.yaml") -> dict[str, Any]:
    kb = _load_error_kb(kb_path)
    errors: list[str] = []
    warnings: list[str] = []
