...

{
  ...
  "backend": "python",
  "outputs": [
    "outputs/reports/dataset_evaluation/dataset_summary.json",
    "outputs/reports/dataset_evaluation/subject_qc_table.csv",
    "outputs/reports/dataset_evaluation/exclusion_recommendations.csv"
  ],
  "metrics": {
    "subjects_total": 2,
    "subjects_include": 2,
