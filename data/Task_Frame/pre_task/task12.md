...
诊断输出结构：
{
  ...
  "issues_total": 0,
  "issues": [],
  "retry_plan_path": "outputs/work/diagnosis/run_subject_preprocess_001/retry_plan.json",
  "outputs": [
    "outputs/work/diagnosis/run_subject_preprocess_001/diagnosis.json",
    "outputs/work/diagnosis/run_subject_preprocess_001/diagnosis_report.md",
    "outputs/work/diagnosis/run_subject_preprocess_001/retry_plan.json",
    "outputs/work/diagnosis/run_subject_preprocess_001/retry_plan.md"
  ],
  "warnings": [],
  "errors": []
}
issue 结构：
{
  ...
  "stdout_log": "outputs/logs/sub-001_spm_smooth_stdout.log",
  "stderr_log": "outputs/logs/sub-001_spm_smooth_stderr.log"
}
retry_plan 结构：
{
  "run_id": "run_subject_preprocess_001",
