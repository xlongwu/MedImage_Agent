...
def write_reho_gpu_candidate_contract(
    ...
    payload = {
        ...
        "planned_outputs": [
            "outputs/derivatives/rsfmri_metrics/{subject_id}/reho_gpu.nii"
        ],
...
def write_dpabi_reho_contract(
    ...
    payload = {
        ...
        "planned_outputs": [
            "outputs/derivatives/rsfmri_metrics/{subject_id}/dpabi_reho.nii",
            "outputs/logs/{subject_id}_dpabi_reho.log"
        ],
        "parameters": {
            "neighborhood": 27,
...
def main() -> int:
    ...
    if approved:
        pipeline = _make_approved_pipeline_copy(
            source=pipeline,
            target=Path("outputs/work/rsfmri/approved_pipeline_reho.yaml"),
        )
